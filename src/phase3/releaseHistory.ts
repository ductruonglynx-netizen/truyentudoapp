...
export const WRITER_RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    title: 'Tập trung ổn định dữ liệu, đồng bộ và trải nghiệm AI hằng ngày',
    items: [
      'Cải thiện an toàn dữ liệu và sao lưu để giảm nguy cơ mất truyện khi làm việc lâu: lưu ổn định hơn với file lớn, khôi phục lại từ mốc gần nhất dễ hơn, và theo dõi lịch sử sao lưu rõ ràng hơn.',
      'Cải thiện đồng bộ nhiều thiết bị để hạn chế ghi đè nhầm khi đăng nhập cùng tài khoản: hệ thống ưu tiên dữ liệu mới hơn, đồng bộ theo nhịp an toàn và tự xử lý lại khi mạng chập chờn.',
      'Cải thiện quyền riêng tư và tách dữ liệu theo tài khoản để tránh lẫn cấu hình giữa nhiều tài khoản dùng chung một máy.',
      'Cải thiện luồng AI viết/dịch để giảm tình trạng trả về dàn ý hoặc nội dung không đúng mong muốn; đầu ra được làm sạch tốt hơn để đọc tự nhiên, rõ đoạn hơn.',
      'Cải thiện AI tạo ảnh bìa để dùng đúng nhà cung cấp bạn đã chọn; khi dịch vụ ảnh bận, hệ thống trả bìa dự phòng ngay để không làm gián đoạn công việc.',
      'Cải thiện độ mượt giao diện và độ tin cậy vận hành: giảm hiện tượng nháy/giật khó chịu, đồng thời tăng lớp theo dõi lỗi để phát hiện và xử lý sự cố sớm hơn.',
    ],
  },
  {
    version: '0.1b',
